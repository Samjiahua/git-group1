...
import com.lenovo.smarttraffic.ui.activity.ACT1_ZHGL;
import com.lenovo.smarttraffic.ui.activity.ACT2_ETC;
import com.lenovo.smarttraffic.ui.activity.BaseActivity;
import com.lenovo.smarttraffic.ui.activity.DTActivity;
import com.lenovo.smarttraffic.ui.activity.Item1Activity;
import com.lenovo.smarttraffic.ui.activity.Item7_SHOUS_Activity;
import com.lenovo.smarttraffic.ui.activity.Item8_WDJT_Activity;
import com.lenovo.smarttraffic.ui.activity.LHJJCActivity;
import com.lenovo.smarttraffic.ui.activity.LKFXActivity;
...
//            super.onBackPressedSupport();
    ...
    public boolean onNavigationItemSelected(@NonNull MenuItem item) {
        ...
        switch (id) {
            ...
            case R.id.item_1:
                string = "账户管理";
                startActivity(new Intent(this, ACT1_ZHGL.class));
                break;
            case R.id.item_2:
                string = "ETC";
            ...
            case R.id.item_5:
                string = "地图";
                startActivity(new Intent(this, DTActivity.class));
                break;
            case R.id.item_6:
                string = "路况分析";
                startActivity(new Intent(this, LKFXActivity.class));
                break;
            case R.id.item_7:
                string = "环境监测";
                startActivity(new Intent(this, LHJJCActivity.class));
                break;
            case R.id.item_8:
                string = "搜索";
                startActivity(new Intent(this, Item7_SHOUS_Activity.class));
                break;
            case R.id.item_9:
                string = "实时交通";
                startActivity(new Intent(this, Item8_WDJT_Activity.class));
                break;
